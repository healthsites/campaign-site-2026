...
1. **Define priorities** through human-centred design workshops with health workers and district health offices
2. **Audit existing data** across Ministry, NSO, and OpenStreetMap sources — harmonizing facility names and identifying gaps
3. **Train on the ground** — teaching regional health offices QGIS so they can manage their own data
4. **Validate in the field** — recruiting and supporting trusted validators who confirm facility locations and services on the ground
5. **Feed back to government** — all validated data flows back to the Ministry of Health as the validator of record
...
- **Open Database Licence.** All data is contributed under ODbL, ensuring its permanent status as a public good.
- **Privacy by design.** We collect no personal data. Our focus is exclusively on facility metadata.
- **Auditable sources.** Every data point is tagged with its source, creating a transparent trail.
- **Ministry authority.** The Ministry of Health retains ultimate authority as the validator of record for its national data.
- **Anti-capture structure.** Commons-based governance prevents any single commercial actor from controlling the shared resource.
...
View the [Greatest Hits: healthsites.io on Twitter (2015-2024)](/about/twitter-timeline/) — a curated archive of 1,067 tweets documenting our evolution from foundation through crisis response to sustainable institutional integration.

Key milestones:
- **2015**: Foundation and launch
- **2018**: First campaign in Senegal (proof of concept)
- **2020-2021**: COVID-19 vaccine distribution data
- **2022-2024**: DRC Ebola response integration
- **2024**: API sustainability model, European Digital Commons
